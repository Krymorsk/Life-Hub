const CACHE="life-hub-v41-settings";
const ASSETS=["./","./index.html","./app.html","./login.html","./login.css","./auth-gate.js?v=40","./style.css","./data-v41.js","./script-v41.js","./login.js","./background.jpg","./manifest.webmanifest","./icon-192.svg","./icon-512.svg","./firestore.rules","./firebase.json"];
